...
Because both geoms use the same `mapping` argument, we can also specify a *global* `mapping` inside the `ggplot()` function call. All geoms will inherit this global mapping, and the resulting figure is identical to the previous one.
