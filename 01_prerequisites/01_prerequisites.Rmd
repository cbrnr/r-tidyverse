...
We can access individual elements of a vector using square brackets, which contain the indexes of all elements we would like to access:
...
3. Compute the areas of circles with diameters 5, 7, 19, and $\pi^{-\frac{1}{2}}$. Put all diameters into a vector `r` and compute the results with one command!
