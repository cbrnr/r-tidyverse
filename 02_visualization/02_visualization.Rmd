...
Note that we can use multiple geoms in a plot by adding each one as a new layer:
...
## Conclusion
With this basic set of ggplot2 building blocks you can create almost any kind of data visualization. In addition to the "Export" button in the "Plots" pane, you can use `ggsave()` to save a plot to a file.
