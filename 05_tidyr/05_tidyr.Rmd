...
Note that because these two columns contain names that would be a syntax error (names must not start with a digit), we have to enclose them with backticks.
