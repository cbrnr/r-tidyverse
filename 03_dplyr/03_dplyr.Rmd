...
In RStudio, you can use the keyboard shortcut <kbd>⌘</kbd>+<kbd>⇧</kbd>+<kbd>m</kbd> (macOS) or <kbd>Ctrl</kbd>+<kbd>⇧</kbd>+<kbd>m</kbd> (Windows and Linux) to insert the pipe operator (you can select between the native and magrittr variants in the "Code" section of RStudio's preferences).
