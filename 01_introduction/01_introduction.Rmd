...
- The ↑/↓ arrow keys access the command history. You can also edit any command before running it again.
...
y > 4  # a comparison evalutates to a logical vector
...
3. Compute the areas of circles with radiuses 5, 7, 19, and $\pi^{-\frac{1}{2}}$. Put all radiuses into a vector `r` and compute the areas with one command!
